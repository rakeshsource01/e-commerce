            ...
            <div className="header-top">
              <div className="container">
                ...
                <div className="header-right">
                  ...
                  <div className="dropdown">
                    <a href="#language"><img src="assets/images/flags/eng.png" alt="ENG Flag" className="dropdown-image" width={14} height={8} /> ENG</a>
                    <div className="dropdown-box">
                      <a href="#ENG">
                        <img src="assets/images/flags/eng.png" alt="ENG Flag" className="dropdown-image" width={14} height={8} />
                        ENG
                      </a>
                      <a href="#FRA">
                        <img src="assets/images/flags/fra.png" alt="FRA Flag" className="dropdown-image" width={14} height={8} />
                        FRA
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="header-call d-xs-show d-lg-flex align-items-center">
                    ...
                    <div className="call-info d-lg-show">
                      <h4 className="chat font-weight-normal font-size-md text-normal ls-normal text-light mb-0">
                        <a href="https://portotheme.com/cdn-cgi/l/email-protection#a586" className="text-capitalize">Live Chat</a> or :</h4>
                              ...
                              <li className="row">
                                <div className="col-6">
                                  <div className="banner banner-fixed menu-banner5 br-xs">
                                    <figure>
                                      <img src="assets/images/menu/banner-5.jpg" alt="Banner" style={{backgroundColor: '#D2D2D2'}} width={410} height={123} />
                                    </figure>
                                ...
                                <div className="col-6">
                                  <div className="banner banner-fixed menu-banner5 br-xs">
                                    <figure>
                                      <img src="assets/images/menu/banner-6.jpg" alt="Banner" style={{backgroundColor: '#9F9888'}} width={410} height={123} />
                                    </figure>
